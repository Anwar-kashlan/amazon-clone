...
import images from "../imgs/HomeImgs/HomeImgs";
import SwiperSlideContainer from "./SwiperSlideContainer";
import Product from "./Product";
import shortid from "shortid";
import ProductImg1 from "../imgs/Product/1.png";
import ProductImg2 from "../imgs/Product/2.png";
import ProductImg3 from "../imgs/Product/3.png";
import ProductImg4 from "../imgs/Product/4.png";
import ProductImg5 from "../imgs/Product/5.png";
import ProductImg6 from "../imgs/Product/6.png";

const Home = () => {
  return (
    <div className={style.home}>
      <div className={style.container}>
        <SwiperSlideContainer images={images} />
